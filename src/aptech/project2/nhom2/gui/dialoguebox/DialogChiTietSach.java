...
public class DialogChiTietSach extends javax.swing.JDialog {
    ...
    //         java.util.logging.Logger.getLogger(DialogChiTietSach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    //         public void run() {
    //             DialogChiTietSach dialog = new DialogChiTietSach(new javax.swing.JFrame(), true);
