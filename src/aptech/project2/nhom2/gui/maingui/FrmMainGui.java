...
public class FrmMainGui extends javax.swing.JFrame {
	...
	private void btnEditBookActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditBookActionPerformed
		...
		if (txtFileAnh.getText().isEmpty()) {
			thongTinSachDAO.addNew(new ThongTinSach(id ,txtTenSach.getText(), tacGiaData, danhMucData, nxbData,
	...
	private void btnDeleteBookActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteBookActionPerformed
		...
		if (JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa sách đã chọn?", "Xác nhận xóa", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE) == 0) {
	...
	public void timKiem(DataTimKiem data) {
		sachs = thongTinSachDAO.searchAdvanced(data.getTenSach(), data.getTacGia(),
				data.getDanhMuc(), data.getNhaXuatBan());
		DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
		model.setRowCount(0);
		sachs.forEach(it -> {
			model.addRow(new Object[] { it.getTen(), it.getTacGia().getTen(), it.getDanhMucSach().getTen(),
